...
- 결정(2026-09-08): ① 관심 미등록이면 안내 + **전체 3개는 그대로 노출**(0개 아님) ② 더 보기는 3개씩(누구나 합류 섹션도 동일) ③ 무대는 홈에서 **빼되 없애지 않음**(별도 섹션) ④ 홈 밴드는 개설/참여 2개까지 ⑤ 명사 빈 자리에도 제안 버튼(조직 카드와 대칭)
