...
>    profile 탭 제거 → 우상단 아바타로 MY 일원화. + 버튼 = 만들기 7단계 (변화 없음).
...
| 명사 챌린지 | 4.11 | Phase 2. 베타는 일반 사용자 챌린지만. |
| 브랜드 챌린지 | 4.2 | Phase 2 B2B. |
| 공익 챌린지 | 4.2 | Phase 2. 사회공헌 카테고리로 일부 욕구 살림. |
...
### Week 7 — v2.5 SNS-first IA 재설계 ⏳ (2026-06-04~)
...
- [ ] CLAUDE.md / BLUEPRINT.md / PITCH.md v2.5 톤 갱신
...
-- - "용기 받은 N명" 카운터는 별도 `story_courage` 또는 reactions 테이블 (Phase 2 정밀화)
```
